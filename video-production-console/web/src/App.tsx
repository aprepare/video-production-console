...
function App() {
  ...
  const createAccount = async (e: React.FormEvent) => { e.preventDefault(); setMessage(newAccount.trim() ? '账号创建需要上传背景图，请在账号设置中完成' : '请输入账号名称'); setNewAccount('') }
